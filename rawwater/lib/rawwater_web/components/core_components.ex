defmodule RawwaterWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RawwaterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RawwaterWeb.Gettext, "errors", msg, opts)
    end
  end
